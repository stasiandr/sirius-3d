...
{
    public class VRCameraSelectControllerLeft : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (VRController.VRController.CurrentDragger == null && OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger))
            {
                SphereCast();
            }
        }
